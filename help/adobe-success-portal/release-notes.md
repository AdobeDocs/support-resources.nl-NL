...
* Elk **[!UICONTROL Accelerators]**/ **[!UICONTROL Activities]** toont naam, status, en begin/eind (die als *wordt geformatteerd maand XX*, *YYYY*).
...
* Gebeurtenissen hebben een kleurcodering: blauw voor **[!UICONTROL Accelerators]**, groen voor **[!UICONTROL Activities]** . Schuif verticaal door KBO&#39;s en horizontaal door week of maand.
* In de knopinfo worden volledige namen weergegeven wanneer tekst wordt afgekapt en de tijdlijn tijdens het schuiven zichtbaar blijft.
