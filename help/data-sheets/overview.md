...
<tr>
  <td>
    <p><strong>Expertondersteuning</strong></p>
  </td>
  <td>
    <p><strong>Ultieme ondersteuning</strong></p>
  </td>
</tr>
<tr>
  <td>
    <p>Met het plan van de Steun van de Expert, kunt u tot 24x7 deskundige zorg voor technische het oplossen van problemen en begeleiding op uw kritieke bedrijfskwesties toegang hebben. Of je vindt snelle oplossingen door te tikken op onze zelfgeleide bronnen, exclusieve best practices en een online gemeenschap van experts en collega's van Adobe.</p><br>
    <p><em>Bij alle Adobe Experience Cloud-licenties inbegrepen.</em></p>
  </td>
  <td>
    <p>Met het Ultimate Support-plan krijgt u de beschikking over high-touchondersteuning met persoonlijke, proactieve hulp en begeleiding van experts. Uw toepassingen van de Adobe zullen veilig en consequent door een team van deskundigen worden gecontroleerd die met uw milieu vertrouwd zijn en op uw bedrijfsdoelstellingen en oplossingsgezondheid concentreren.</p>
  </td>
</tr>
</table>
...
<tr>
  <td>
    <ul>
      <li><strong>Onmiddellijke online ondersteuning</strong> - (24x7) via chat of webportal </li>
      <li><strong>Telefonische ondersteuning</strong> - 24x7 ondersteuning voor P1-noodsituaties, ondersteuning van kantooruren voor P2/P3/P4 </li>
      <li><strong>Geleide leerbronnen</strong> - Verken onze kennishub, ons Experience League en breid uw kennis uit met productdocumentatie, mogelijke caseoplossingen, probleemoplossingsvideo's en best practices. </li>
      <li><strong>Gepoold ervaren team en zwerm methodologie</strong> - Wereldwijde teams zijn gestructureerd in 'Pods', met deskundigen uit verschillende achtergronden die zijn bijeengeroepen om de snelste oplossing te bieden voor een bepaald probleem. </li>
      <li><strong>Onbeperkte supportverzoeken</strong> - Neem contact op met experts voor een onbeperkt aantal problemen, beheer problemen met proactieve waarschuwingen en krijg snellere oplossingen via geprioriteerd escalatiebeheer.</li>
      <li><strong>Gebeurtenisplanning (optionele invoegtoepassing)</strong> - Experts evalueren en rapporteren over uw omgeving en bieden advies en ondersteuning ter voorbereiding op kritieke gebeurtenissen met veel verkeer</li>
    </ul>
  </td>
  <td>
    <ul>
      <li><strong>Aangewezen Technical Account Manager en Support Service Manager</strong> - Toegewezen experts organiseren een holistische persoonlijke supportervaring op verschillende oplossingen, pleiten voor feedback en problemen, coördineren regelmatige servicebeoordelingen en bieden gepersonaliseerd inzicht in kritieke uitval van services. </li>
      <li><strong>Proactieve technische en operationele diensten </strong> - Profiteer van proactieve begeleiding, zoals planning voor de levering van services, health check, onderhoud en best practices, upgrade-/migratieplanning en aanbevelingen voor gebruiksscenario's. </li>
      <li><strong>Advies starten</strong> - Hulp bij de acceptatie en implementatie van uw oplossingsontwerp met adviesservices voor de introductie en implementatie van best practices voor nieuwe implementatie. </li>
      <li><strong>Voorbereiden en beoordelen van release</strong> - Bekijk nieuwe functies en bepaal de noodzakelijke onderhouds- en probleemoplossingsactiviteiten ter voorbereiding op de nieuwste versies en platforms. </li>
      <li><strong>Kennisoverdracht </strong> - Technische accountmanagers delen richtlijnen en beste praktijken met betrekking tot specifieke functies in verschillende oplossingen </li>
      <li><strong>Maximaliseer uptime met geprioriteerde technische ondersteuning</strong> - Profiteer van snelle ondersteuning met agressievere responstijden voor een onbeperkt aantal problemen, analyse van de oorzaak van P1- en P2-problemen en gepersonaliseerd escalatiebeheer </li>
      <li><strong>Routekaart-revisies</strong> - Herzie de toekomstige routekaarten van Adobe-oplossingen, vergelijk en lijn uw routekaart met ons om risico's te beperken en plannen voor grote veranderingen. </li>
      <li><strong>Gebeurtenisplanning (add-on)</strong> - Experts evalueren en rapporteren over uw omgeving en bieden advies en ondersteuning ter voorbereiding op kritieke gebeurtenissen met veel verkeer</li>
    </ul>
  </td>
</tr>
</table>
...
| Gebeurtenisbeheer | Technical Account Director (alleen Ultimate) | Geavanceerde cloudondersteuning |
|---|---|---|
| **Gebeurtenisplanning** - plannen, voorbereiden, begeleiden, communiceren <br>**Uitvoering van gebeurtenis** - Configureren, implementeren, testen, controleren, controleren <br>**Gebeurtenisbewaking** - Live controle, systeemcontrole, situatieruimte | **Toezicht** betrokkenheid en uitvoering om het hoogste prestatieniveau te garanderen. <br>**Beheert uitvoerende relaties** door rapportage, revisies en toekomstige planningsbesprekingen. <br>**Leest de technische omgeving** evaluaties, risicobeperking en voorspellende inzichten om het technische quotiënt te verbeteren. <br>**Hiermee lijnt u uitlijnen en pleit u voor** met technische teams om de uitvoering van taken te versnellen en het oplossen van problemen te versnellen. <br>**Activiteiten en supportplanning** voor vloeiende levering en maximale waarde. <br>**Communiceren en touringcars** de interne en externe belanghebbenden over waardevolle stuurprogramma&#39;s en de strategie voor betrokkenheid | Topservice en waarborg voor klanten van Adobe Experience Manager as a Cloud Service.  <br>Versnelt uw overstap naar de cloud met hulp bij het navigeren in complexe scenario&#39;s voor cloudtechnologie met proactieve optimalisatie, afgedwongen best practices en het garanderen van een superieure go-live ervaring <br> **Implementatie:** Migratieprep, maandelijkse en live check-in <br>**Betrokkenheid:** Kickoff, aan boord nemen, beste praktijken testen <br>**Go-Live:** Gebeurtenisondersteuning, domeincontrole, productieoverdracht <br>**Uitvoeren en gebruiken:** Proactieve optimalisatiebenadering en inzicht in oplossingen/rapportering <br> |
| **Voorbeeldscenario&#39;s voor gebeurtenisbeheer:** <ul><li>Zwarte vrijdag + Cyber maandag </li><li>Belangrijk sportevenement (bijv. Superbowl, Olympische Spelen, FIFA World Cup) </li><li>Speciale winkelevenementen of belangrijke jaarlijkse promoties </li></ul> | **Een technische account Director kan een grote toegevoegde waarde hebben als een of meer van de volgende situaties true zijn.** <ul><li>U hebt meerdere Adobe Experience Cloud-toepassingen. </li><li>U hebt ondersteuning nodig voor meerdere regio&#39;s, merken of bedrijfseenheden. </li><li>U hebt complexe gebruiksgevallen met Adobe-technologie en u hebt strategisch leiderschap nodig.</li></ul> | **Wanneer hebt u ondersteuning voor Advanced Cloud nodig?** <ul><li>Als je Adobe Experience Manager as a Cloud Service hebt. </li><li>Als u een migratie naar as a Cloud Service Experience Manager ondergaat. </li><li>Als u te maken hebt met strakke deadlines of complexe gebruikscituaties met as a Cloud Service Experience Manager. </li></ul> |
