...
Wanneer een organisatie aan globaal beleid wordt toegevoegd, blijven de producten in de organisaties die gebruikend de mapper van de Organisatie worden toegevoegd als aankopen; [ de aantallen van de Toewijzing van het 0} Product houden rollup bij deze organisaties.](https://helpx.adobe.com/enterprise/global-admin-console/allocate-products.html)
