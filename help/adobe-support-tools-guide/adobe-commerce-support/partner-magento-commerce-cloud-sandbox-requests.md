...
Dit artikel in veelgestelde vragen bevat koppelingen naar nuttige bronnen voor Adobe Commerce over sandboxaanvragen voor cloudinfrastructuur. Het verduidelijkt ook dat de partners geen kaartjes onder de organisatie van een klant moeten voorleggen wanneer zij niet namens die klant handelen.

## Hoe vernieuw ik mijn Adobe Commerce op de sandbox met cloudinfrastructuur? {#how-do-i-refresh-my-cloud-sandbox}

Zie [&#x200B; milieu van het Terugstellen op Wolk &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/how-to/reset-environment-on-cloud) in onze basis van de steunkennis.
...
Verzend een steunkaartje in de [&#x200B; sectie van de Steun op Experience League &#x200B;](https://experienceleague.adobe.com/en/support?support-tab=home#home).
...
> **Voorbeeld**
> Hoewel deze sectie verwijst naar Adobe Commerce Cloud-sandboxaccounts, geldt dezelfde vereiste ook wanneer partners in interne omgevingen werken en niet voor een specifieke klant. De partners moeten geen steunverzoeken onder een klantenorganisatie voorleggen tenzij zij actief in naam van die klant betrokken zijn.
