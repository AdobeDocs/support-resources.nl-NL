...
![Nieuw](../adobe-support-tools-guide/assets/new.svg) - Nieuwe functies
![Oplossing](../adobe-support-tools-guide/assets/fix.svg) - Oplossingen en verbeteringen
![Bug](../adobe-support-tools-guide/assets/bug.svg) - Bekende problemen
...
- **Adobe Target**
   - Naam activiteit
   - Site-URL (naam eigenschap tags) / HAR- of Assurance-logboek
- **Adobe Analytics**
   - RSID
   - Site-URL (naam eigenschap Tags) / HAR- of Assurance-logboek / cURL / Foutopsporingslogbestand
   - Workspace-snelkoppeling
- **Adobe Journey Optimizer (AJO)**
   - Reis-id of Reisadres-URL
   - Voorbeeldprofiel
- **Real-Time Customer Data Platform (RTCDP)**
   - Betrokken component-id (doel-id, profiel-id, publiek-id, gegevensset-id of gegevensstroom-id)
   - HAR-bestand/Assurance-logbestanden
